...
public class RotateDrawable extends Drawable {
     ...
     */
    public RotateDrawable(Resources res) {
        mBitmapState = new BitmapState((Bitmap) null);
     ...
     * the display metrics of the resources.
     */
    public RotateDrawable(Resources res, Bitmap bitmap) {
     ...
     */
    @Deprecated
    public RotateDrawable(String filepath) {
     ...
     * Create a drawable by opening a given file path and decoding the bitmap.
     */
    public RotateDrawable(Resources res, String filepath) {
        this(new BitmapState(BitmapFactory.decodeFile(filepath)), null);
        mBitmapState.mTargetDensity = mTargetDensity;
        if (mBitmap == null) {
            android.util.Log.w("BitmapDrawable", "BitmapDrawable cannot decode " + filepath);
     ...
     */
    @Deprecated
    public RotateDrawable(java.io.InputStream is) {
     ...
     * Create a drawable by decoding a bitmap from the given input stream.
     */
    public RotateDrawable(Resources res, java.io.InputStream is) {
        this(new BitmapState(BitmapFactory.decodeStream(is)), null);
        mBitmapState.mTargetDensity = mTargetDensity;
        if (mBitmap == null) {
            android.util.Log.w("BitmapDrawable", "BitmapDrawable cannot decode " + is);
    ...
    public void draw(Canvas canvas) {
        ...
        if (bitmap != null) {
            ...
            if (shader == null) {
                ...
                canvas.drawBitmap(tempBitmap, null, mDstRect, state.mPaint);
                bitmap.recycle();
                mBitmap = tempBitmap;
            } else {
                if (mApplyGravity) {
    ...
    public void inflate(Resources r, XmlPullParser parser, AttributeSet attrs)
        ...
        TypedArray a = r.obtainAttributes(attrs, new int[]{});
        ...
        paint.setFilterBitmap(paint.isFilterBitmap());
        paint.setDither(paint.isDither());
    ...
    private RotateDrawable(BitmapState state, Resources res) {
        mBitmapState = state;
        if (res != null) {
