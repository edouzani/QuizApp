...
package com.almadev.znaniesila.videoplayer;
...
public class MovieViewControl implements MediaPlayer.OnErrorListener,
    ...
    public MovieViewControl(View rootView, Context context, Uri videoUri) {
        ...
        /*int resId = mVideoView.getContext().getResources().getIdentifier(
        		"raw/video", "raw", mVideoView.getContext().getPackageName());
